  ...
  return (
    ...
    >
      <a 
        ...
        className="w-full flex justify-center items-center gap-3 bg-accent-green text-white font-bold text-lg py-4 px-6 rounded-2xl shadow-[0_-10px_40px_rgba(37,211,102,0.4)] active:scale-95 transition-transform animate-soft-pulse"
      >
