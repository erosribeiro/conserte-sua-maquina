...
export default function Hero() {
  return (
    <section className="relative w-full min-h-[90vh] md:min-h-screen flex items-center overflow-hidden pt-28 md:pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <motion.div 
          ...
          className="max-w-2xl py-8 md:py-24"
        >
          <span className="inline-block px-4 py-2 bg-brand-light text-primary-blue rounded-full text-sm font-bold mb-4 md:mb-6">
            Atendimento Imediato
          </span>
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-primary-blue tracking-tight mb-4 md:mb-6 leading-[1.1] text-balance">
            Conserto de Máquina de Lavar e Lava e Seca.
          </h1>
          ...
          <div className="mb-6 md:mb-10">
            <a 
              ...
              aria-label="Agendar conserto de máquina de lavar agora via WhatsApp"
              title="Fale com um Especialista no WhatsApp"
              className="inline-flex w-full sm:w-auto items-center justify-center gap-3 bg-accent-green hover:bg-green-500 text-white px-8 py-4 min-h-[56px] rounded-2xl text-lg font-bold transition-all hover:-translate-y-1 drop-shadow-premium hover:shadow-[0_20px_25px_-5px_rgba(37,211,102,0.4)]"
            >
